 ...
 */
class Training
  : public ivqML::Optimizer::GradientDescent< _M, Eigen::Block< _M::TMatrix >, _M::TMatrix::ColXpr >
{
public:
  using Self = Training;
  using Superclass = ivqML::Optimizer::GradientDescent< _M, Eigen::Block< _M::TMatrix >, _M::TMatrix::ColXpr >;

...
def TrainLogisticRegression( X, Y, a = 1e-1, e = 1e-8 ):
  ...
  print( 'Iteration =', i - 1, ': J =', J, ': dJ =', dJ )
  while e < dJ and i < 200:
    W -= a * dW
    b -= a * db
...
# Train parameters
[ W, b ] = TrainLogisticRegression( X, Y, 1e-2 )

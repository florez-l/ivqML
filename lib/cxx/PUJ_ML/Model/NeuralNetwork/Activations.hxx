...
// =========================================================================
#ifndef __PUJ_ML__Model__NeuralNetwork__Activations__hxx__
#define __PUJ_ML__Model__NeuralNetwork__Activations__hxx__
...
// -------------------------------------------------------------------------
template< class _M >
typename PUJ_ML::Model::NeuralNetwork::Activations< _M >::
TFunction PUJ_ML::Model::NeuralNetwork::Activations< _M >::
operator()( const std::string& n )
{
  ...
  if( a == "linear" )
    return(
      ...
      {
        if( d ) A = TMatrix::Ones( Z.rows( ), Z.cols( ) );
        else    A = Z;
      }
      );
  else if( a == "relu" )
...
#endif // __PUJ_ML__Model__NeuralNetwork__Activations__hxx__

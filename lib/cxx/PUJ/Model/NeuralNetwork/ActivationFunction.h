...
// -------------------------------------------------------------------------
#define PUJ_NN_ActivationFunction( _n_, _a_, _v_ ) \
      template< class _TScalar, class _TTraits = PUJ::Traits< _TScalar > > \
      class PUJ_ML_EXPORT _n_ \
      : public ActivationFunction< _TScalar, _TTraits > \
      { \
...
namespace PUJ
{
  namespace Model
  {
    namespace NeuralNetwork
    {
      ...
      PUJ_NN_ActivationFunction( SoftMin );
      PUJ_NN_ActivationFunction( Tanh );
      
      // -- Functions with parameters
      PUJ_NN_ActivationFunction( ELU, Alpha, 1e-1 );
      PUJ_NN_ActivationFunction( RandomReLU, Alpha, 1e-1 );
